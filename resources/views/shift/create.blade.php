            ...
            <form method="POST" action="{{ route('shift.store') }}">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <x-input id="nama_shift" name="nama_shift" type="text" class="mt-1 block w-full" required />
                        <x-input-error for="nama_shift" class="mt-2" />
                    </div>
                    <div>
                        <x-label for="start_time" value="Waktu Mulai" />
                        <x-input id="start_time" name="start_time" type="time" class="mt-1 block w-full" required />
                        <x-input-error for="start_time" class="mt-2" />
                    </div>
                    <div>
                        <x-label for="end_time" value="Waktu Selesai" />
                        <x-input id="end_time" name="end_time" type="time" class="mt-1 block w-full" required />
